...
if(isset($_POST['sbm'])){
    ...
    prd_price='$prd_price', prd_warranty='$prd_warranty', 
    prd_accessories = '$prd_accessories', prd_promotion='$prd_promotion', 
    prd_new='$prd_new', prd_image='$prd_image', cat_id=$cat_id, 
    prd_status = $prd_status, prd_featured= $prd_featured, 
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea id="mt1" name="prd_details" required class="form-control" rows="3"><?php echo $row['prd_details'] ?></textarea>
                                        <script> CKEDITOR.replace( 'mt1' ); </script>
                                    </div>
