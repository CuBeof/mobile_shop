...
if (isset($_SESSION['cart'])) {
    ...
    $str = implode(", ", $arr);
    $sql = "SELECT * FROM product Where prd_id IN($str)";
...
?>
        ...
        <form method="post">
            ...
            ?>
                <div class="cart-item row">
                    ...
                    <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo number_format($total_price); ?>đ</b><a href="#">Xóa</a></div>
                </div>
            <?php } ?>
            <div class="row">
                <div class="cart-thumb col-lg-7 col-md-7 col-sm-12">
                ...
                <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo number_format($total_all); ?>đ</b></div>
            </div>
        </form>
    ...
    <tr>
        ...
        <td width="20%"><b><font color="#FF0000">'.number_format($total_all).' đ</font></b></td>
    </tr>
    </table>
    ';
    $str_body .= '
